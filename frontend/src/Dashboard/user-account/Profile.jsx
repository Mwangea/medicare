    ...
    <div className="mt-10">
      <form onSubmit={submitHandler}>
        ...
        <div className="mb-5 flex items-center justify-between">
          <label className="text-headingColor font-bold text-[15px] leading-7 px-4 py-2 focus:outline-none">
            Gender:
            <select
              name="gender"
        ...
        <div className="mt-3">
          <button
            disabled={loading}
            type="submit"
            className="w-full bg-primaryColor p-3 text-[16px] leading-7 rounded-md text-white ml-auto"
          >
